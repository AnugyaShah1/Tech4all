...
public class StringUtils {
	...
	public static final String INSERT_USERS = "INSERT INTO users "
			+ "(First_Name, Last_Name, Username, DOB, Gender, Phone, Mail, Address, Password, ProfileImg) "
			+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	public static final String GET_USERS_INFO_LOGIN = "SELECT * FROM users WHERE Username = ?";
	
	public static final String GET_USER_DETAIL = "Select * FROM users WHERE Username=?";
	public static final String UPDATE_USER_INFO = "UPDATE users SET First_Name=?, Last_Name=?, DOB=?, Gender=?, Phone=?, Mail=?, Address=?, ProfileImg = ? WHERE  Username=?";
	...
	public static final String GET_PRODUCT_DETAILS = "SELECT * FROM products WHERE ProductID = ?";
	...
	public static final String PFP_IMG = "image";
	...
	//for users
	public static final String IMAGE_DIR_USER = "Apps\\Eclipse\\Tech4All\\src\\main\\webapp\\resources\\Images\\Users\\";
	public static final String IMAGE_DIR_SAVE_USER = "E:" + File.separator + IMAGE_DIR_USER;
	...
	public static final String PROD_LIST_SERVLET = "/ProductsList";
	public static final String USER_DATA_SERVLET = "/UserDataModify";
