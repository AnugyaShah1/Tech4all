...
public class UserModel {
	...
	public void setPfpFromDB(String imageUrl) {
	  ...
	  public int getRoleId() {
	    ...
	    public String getRole() { // New getter for the role name
	        return role;
	    }

	    public void setRole(String role) { // New setter for the role name
	        this.role = role;
	    }

	    // This method determines if the user is an admin
	    public boolean isAdmin() {
	        // Assuming '1' is the role_id for the 'Admin' role
