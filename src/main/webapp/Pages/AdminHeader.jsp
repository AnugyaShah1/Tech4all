...
%>
	...
	<nav>
		<a href="/Tech4All/Pages/Admin.jsp"><i class="fa-solid fa-bars"></i>Overview</a>
		<a href="http://localhost:8081//Tech4All/ProductsList"><i class="fa-solid fa-box-open"></i>Products</a>
		<a href="http://localhost:8081//Tech4All/OrdersList"><i class="fa-solid fa-clipboard-list"></i>Orders</a>
	</nav>
</body>
</html>